...
(function () {
  ...
  function bubbleZeilenAufbauen(bubbleEl, text, direction) {
    ...
    zeilen.forEach(function (zeile) {
      ...
      // Uebersicht) waere als komplett leeres <div> sonst quasi unsichtbar
      // (0 Hoehe ohne Inhalt) - ein geschuetztes Leerzeichen laesst die
      // Zeile genau eine normale Zeilenhoehe hoch werden, wie eine echte
      // freie Zeile im Text statt einer kleinen kuenstlichen Luecke.
      if (zeile === '') { div.innerHTML = '&nbsp;'; bubbleEl.appendChild(div); return; }
